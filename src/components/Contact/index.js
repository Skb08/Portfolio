...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_rhdd9re', 'template_j4ktxci', form.current, '_E9P2OWOOR5xcUXI0')
      .then((result) => {
        setOpen(true);
        form.current.reset();
      }, (error) => {
    ...
    <Container>
      <Wrapper>
        ...
        <ContactForm ref={form} onSubmit={handleSubmit}>
          ...
          <ContactInputMessage placeholder="Message" rows="4" name="message" type='text' required />
